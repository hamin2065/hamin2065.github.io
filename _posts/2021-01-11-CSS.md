...
![coding](../../../assets/img/posts/2021-01-12-img1.png)
...
![coding](../../../assets/img/posts/2021-01-13-img2.png)
...
는 두 개의 박스를 나란히 놓는 경우 첫 번째 박스는 150px의 크기로 하고 나머지 하나는 남은 공간에 놓는다 둘다 fr로 설정한 경우에는 두 박스의 크기가 같아진다.
